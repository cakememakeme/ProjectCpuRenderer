...
std::vector<Mesh> GeometryGenerator::ReadFromFile(std::string basePath, std::string filename)
{
    MeshLoader modelLoader;
    vector<Mesh> meshes = modelLoader.Load(basePath, filename);
...
Mesh GeometryGenerator::MakeBox()
{
